...
import { studying } from '@/data/Studying'
      ...
      <div className="mx-auto max-w-5xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          <div>
            ...
            <p className="text-foreground-muted text-sm leading-relaxed mb-8 max-w-md">
              Estou aberto a oportunidades como Full Stack Developer,
          ...
          <div>
            ...
            <div className="space-y-4">
              {studying.map((item) => (
                <div
                  key={item.title}
                  className="border border-border bg-surface p-4 transition-colors"
                >
        ...
        <footer className="mt-24 pt-8 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="text-xs text-foreground-muted">
            Guilhermer V. — Full Stack Developer
          </div>
          <div className="text-xs text-foreground-muted">
            © 2026 — Built with Next.js 16 + Tailwind
          </div>
        </footer>
      </div>
    </section>
